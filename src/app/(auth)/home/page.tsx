...
// ⭐ FRONTEND RATINGS (Hardcoded)
// IMPORTANT: no trailing commas to avoid strict-runtime issues
const RATINGS = [
      ...
      <header className="sticky top-0 z-30 backdrop-blur bg-slate-950/70 border-b border-slate-800">
        <div className="max-w-7xl mx-auto px-8 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            {/* visual-only notification bell */}
            <button
              type="button"
              aria-label="Notifications"
              className="p-2 rounded-xl border border-slate-700 hover:border-blue-500 transition"
            >
              🔔
            </button>
